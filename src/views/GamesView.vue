...
<template>
  <h1>Memory</h1>
  <div class="gameArea">
    <!-- kanske döper denna till memory istället -->
    <h4>Senast valda kort: {{ currVal }}</h4>
    <div class="boxHolder" />
      <div
        class="box"
